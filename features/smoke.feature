Feature: TidGi Application Launch
  ...
  @smoke
  Scenario: Git operations calibration — uncommitted changes detection
    # Measures git operations: file modification, watch-fs detection,
    # git menu navigation, and uncommitted changes rendering.
    # This is the slowest real-world scenario type.
    When I launch the TidGi application
    And I wait for the page to load completely
    And I should see a "page body" element with selector "body"
    Then I should see a "default wiki workspace" element with selector "div[data-testid^='workspace-']:has-text('wiki')"
    ...
    And I modify file "{tmpDir}/wiki/tiddlers/Index.tid" to contain "Modified Index content - calibration"
