...
function _escapeCssString(value: string): string {
  return value
    .replace(/\\/g, '\\\\')
    .replace(/"/g, '\\"')
    .replace(/[\n\r\f]/g, (character) => {
...
function _getLiveSortableRect(
  ...
  const element = document.querySelector<HTMLElement>(`[data-testid="${_escapeCssString(testId)}"]`);
