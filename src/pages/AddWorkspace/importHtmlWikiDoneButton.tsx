...
export function ImportHtmlWikiDoneButton({
    ...
    const onSubmit = useImportHtmlWiki(isCreateMainWorkspace, isCreateSyncedWorkspace, form, wikiCreationMessageSetter, hasErrorSetter, errorInWhichComponentSetter);
