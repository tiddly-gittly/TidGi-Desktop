...
export default function RemoteTerminal(): React.JSX.Element {
  ...
  const loadPeers = useCallback(async () => {
    try {
      const connectedPeers =
        await window.service.memeloopNode.getConnectedPeers();
  ...
  const loadSessions = useCallback(async () => {
    ...
    try {
      const sessionList =
        await window.service.remoteTerminal.listSessions(selectedNodeId);
              ...
              <>
                ...
                <TerminalInputWrapper>
                  ...
                  <Button
                    ...
                    disabled={
                      selectedSession.status !== "running" || !inputValue.trim()
                    }
                    endIcon={<SendIcon />}
                  >
                    Send
