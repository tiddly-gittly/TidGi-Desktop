              ...
              <TableContainer sx={{ mb: 3 }}>
                <Table size='small'>
                  <TableHead>
                    <TableRow>
                      <TableCell>
                        {t('Preference.WorkerDebugWorkspace')}
                      </TableCell>
                      <TableCell>
                        <Tooltip
                          title={t('Preference.WorkerDebugThreadIdTooltip')}
                          placement='top'
                        >
                      ...
                      <TableCell>
                        {t('Preference.WorkerDebugActions')}
                      </TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                      ...
                      <TableRow key={info.workspaceID}>
                        ...
                        <TableCell>
                          <Typography variant='body2'>
                            {info.isRunning && info.threadId > 0
                              ? info.threadId
                              : '-'}
                          </Typography>
                        </TableCell>
                        ...
                        <TableCell>
                          <Chip
                            label={info.isRunning
                              ? t('Preference.WorkerDebugRunning')
                              : t('Preference.WorkerDebugStopped')}
                            size='small'
                        ...
                        <TableCell>
                          <Button
                            ...
                            onClick={() => {
                              void window.service.native.openURI(
