...
import { DeviceNetworkServiceIPCDescriptor } from '@services/deviceNetwork/interface';
...
import { HtmlWikiServiceIPCDescriptor } from '@services/htmlWiki/interface';
import type { ILogViewerService } from '@services/logViewer/interface';
import { LogViewerServiceIPCDescriptor } from '@services/logViewer/interface';
...
export function bindServiceAndProxy(): void {
  ...
  container.bind<IDeviceNetworkService>(serviceIdentifier.DeviceNetwork).to(DeviceNetworkService).inSingletonScope();
  ...
  container.bind<IHtmlWikiService>(serviceIdentifier.HtmlWiki).to(HtmlWiki).inSingletonScope();
  container.bind<ILogViewerService>(serviceIdentifier.LogViewer).to(LogViewerService).inSingletonScope();
  ...
  const logViewerService = container.get<ILogViewerService>(serviceIdentifier.LogViewer);
  ...
  registerProxy(logViewerService, LogViewerServiceIPCDescriptor);
