...
const createWorkspaceView = (name, isSubWiki, port, homeUrl, picture, transparentBackground) => {
  const newWorkspace = createWorkspace(name, isSubWiki, port, homeUrl, transparentBackground);
